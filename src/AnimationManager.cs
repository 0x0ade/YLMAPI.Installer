...
namespace YLMAPI.Installer {
    public static class AnimationManager {
        ...
        public static int InvalidatedRoot = 0;

        public static Control AnimationRoot;

        public static List<Animation> Animations = new List<Animation>();

        private static IAsyncResult _CurrentRootInvalidate;

        public static Animation Animate(this Control c, Action<Animation, float> a, float dur = 0.3f, bool loop = false, bool smooth = true, Func<float, float> easing = null, bool run = true) {
        ...
        public static void Run(Animation a) {
            lock (Animations)
                Animations.Add(a);
            a.Init();
            if (_Thread == null)
        ...
        private static Action<Control, bool> _Invalidate;
        public static void Invalidate(Control c, bool invalidateChildren) {
            c.Invalidate(false);
        }
        ...
        public static void InvokeSuspend(Control c) {
            if (c == null || c.IsDisposed)
                return;
        ...
        private static Action<Control> _Suspend;
        public static void Suspend(this Control target) {
        ...
        public static void InvokeResume(Control c) {
            if (c == null || c.IsDisposed)
                return;
        ...
        private static Action<Control> _Resume;
        public static void Resume(this Control target) {
    ...
    public abstract class Animation {
        ...
        public virtual void Init() {
            ...
            Control.Invalidated += (s, e) => AnimationManager.Invalidated++;
        ...
        public virtual void Update() {
            ...
            if (Duration > 0f) {
                Loop:
                t = (AnimationManager.Time - TimeStart) / Duration;
                if (t >= 1f) {
                    End();
                    if (!Loop) return;
                    Start();
        ...
        public void Start() {
            ...
            TimeStart = AnimationManager.Time;
